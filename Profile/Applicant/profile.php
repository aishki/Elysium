...
// Validate input data if form is submitted
                        ...
                        <div class="content-container">
                                ...
                                <div class="details">
                                    <div>
                                        <table>
                                            <tr>
                                                <td class="title" rowspan="6"><img src="../../Assets/default_profile.jpg" alt="Profile Picture" class="profile-pic"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="bfont"><?php echo $_SESSION['user_info']['userLevel']; ?></td>           
                                            </tr>    
                                            ...
                                            <tr>
                                                ...
                                                <td class="data"><?php echo $_SESSION['user_info']['gender']; ?></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td class="title">Age</td>
                                                <td class="data"><?php echo $_SESSION['user_info']['age']; ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="additional-details">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td class="data"><?php echo $_SESSION['user_info']['addLine'] . ', ' . $_SESSION['user_info']['brgy'] . ', ' . $_SESSION['user_info']['city'] . ', ' . $_SESSION['user_info']['province']; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="title">Highest Educational Attainment</td>
                                                <td class="data"><?php echo $_SESSION['user_info']['educ']; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="title">Marital Status</td>
                                                <td class="data"><?php echo $_SESSION['user_info']['mstat']; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="title">Date of Birth</td>
                                                <td class="data"><?php echo $_SESSION['user_info']['dob']; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="title">Submitted Documents</td>
                                                <td class="data"><?php echo $_SESSION['user_info']['docs']; ?></td>
                                            </tr>
                                        </table>
                                    </div> 
                                </div>  <!-- End details -->
