...
<body class="default">
    <div class="main-container">
                ...
                <button class="p_option" data-corresponding-div="pOption_3">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 11.25H16.5V12.75H10.5V11.25Z" fill="#7D8590"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 7.5H16.5V9H10.5V7.5Z" fill="#7D8590"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 15H16.5V16.5H10.5V15Z" fill="#7D8590"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 7.5H9V9H7.5V7.5Z" fill="#7D8590"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 11.25H9V12.75H7.5V11.25Z" fill="#7D8590"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 15H9V16.5H7.5V15Z" fill="#7D8590"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 4.5L4.5 3.75H19.5L20.25 4.5V19.5L19.5 20.25H4.5L3.75 19.5V4.5ZM5.25 5.25V18.75H18.75V5.25H5.25Z" fill="#7D8590"></path>
                        </g>
                    </svg>
                    Job List
                </button>
        ...
        <div class="p_container">
            ...
            <!-- Job List -->
            <?php include 'a_jobList.php' ?>

            <!-- Additional Files -->
            <? //php include 'a_addFiles.php' 
            ?>
