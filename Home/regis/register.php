...
<body class="default">
    ...
    <div class="cntr">
        ...
        <div class="regis_container">
            ...
            <!-- Right Side -->
            <form class="regisForm" id="registrationForm" method="POST" action="../r_controller/r_controller.php" onkeydown="return event.key != 'Enter';" onsubmit="return validateForm()">
                ...
                <div class="acc_type stage-div" id="acc_type" style="display: none;">
                    ...
                    <div class="access-options">
                        <button type="button" class="access-option buy-services" id="buyServicesBtn">
                            <svg id='Bossy_24' width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
                        ...
                        <button type="button" class="access-option provide-services" id="provideServicesBtn">
                            <svg id='Taxi_Wave_Businessman_24' width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
                ...
                <div class="gen_info stage-div" id="gen_info" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="select name-suffix-buttons">
                            ...
                            <div class="selectedOption" data-default-suffix="N/A" data-jr="Jr." data-sr="Sr." data-ii="II" data-iii="III" data-iv="IV">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="arrow">
                                    <path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" fill="rgb(255,255,255)">
                                    </path>
                                </svg>
                            </div>
